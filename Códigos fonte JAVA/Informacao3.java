...
public class Informacao3 {
    ...
    public static class MapperImplementacao3 extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void map(Object chave, Text valor, Context context) throws IOException, InterruptedException{
            ...
            if(campos.length == 10){
                int ocorrencias = 1;
                String ano = campos[1];
                context.write(new Text(ano), new IntWritable(ocorrencias));
            }
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException{
        ...
        String arquivoSaida = "/home2/ead2021/SEM1/gabriela.gondo/Desktop/ImplementacaoLocalMR/OperacoesComerciais/Informacao3/TransacoesPorAno";
        ...
        job.setMapperClass(MapperImplementacao3.class); //Indicando a classe Mapper
        job.setReducerClass(ReducerImplementacao3.class); //Indicando a classe Reducer
